...
# ╔═╡ 3be8ca10-0a86-11ec-3d64-d506f1684e71
begin
	using PlutoUI, Plots
	using LinearAlgebra
	using FileIO, CSV
...
# ╔═╡ 65b8ed44-769b-4dbb-bb99-60f07cf46845
begin
	window = 20
	num_bit_offset = 300
	start_point = 95
...
# ╔═╡ eae9a19f-2791-47ac-ae32-29b32a7f7fc8
md"#### Helper"

# ╔═╡ 2183069e-56cd-4852-bd84-a32a605da7e2
...
# ╔═╡ 61f3992d-a814-44ae-bbe2-7032a097f957
begin
	x = start_point:end_point
	y = [transmitter_vec[start_point:end_point] transmitter_vec[repeat_one:repeat_one_end]]
	plot(x, y, title = "Bit Recurrence Check", label=["Original" "Repeated"])
end
