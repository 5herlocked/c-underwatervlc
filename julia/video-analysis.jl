...
begin
	video_url = ""
	if testing
		video_url = "E:\\MORSE datasets\\temp_var\\28c\\may_20_on_100fps_28c.avi"
	else
		md"Pick Video to manipulate: $(@bind video_url PlutoUI.FilePicker())"
	end
end
...
md"Frame Number: $(@bind frame_number PlutoUI.NumberField(1:30000))"
...
gray_image = ImageCore.Gray.(frame)

# ╔═╡ 0bccb699-0223-4eb0-9665-941980b32219
md"### Helper Functions"

# ╔═╡ 181d8884-1ec2-433a-b232-42705c51f82d
...
git-tree-sha1 = "aeca804b0335293cabcef6193b81c265175d8bbf"
