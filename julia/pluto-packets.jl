...
# ╔═╡ 8d814450-26e8-11ec-3703-65edc0bd1b64
using CSV, Query, DataFrames, Statistics

# ╔═╡ 47fa452e-1e92-48dc-95a3-d078ef58806c
begin
    data_location = "C:\\Users\\camv7\\Downloads\\MORSE\\"
    available = readdir(data_location)
    available = available |> @filter(occursin(".csv", _)) |> collect
end

# ╔═╡ 6b5741e6-af7f-43f6-af72-a7dd8c24fe09
...
# ╔═╡ a36043d1-44e2-4ffd-aa4f-c6cbfff2b9ec
# analyse section
# begin
...
# ╔═╡ cc911192-8561-433c-8c81-8514231e1101
md"# BER Section"

# ╔═╡ 35d89765-5aac-4dc5-9d17-7daa02ad3f29
begin
...
# ╔═╡ 723a3442-951a-4134-a21d-31921251db0c
